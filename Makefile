...
SRC		=	$(SRCPATH)base/math.c					\
			...
			$(SRCPATH)core/handlers/spritesheet_handler.c		\
			...
			$(SRCPATH)games/spaceinvaders/objects/alienrocket.c	\
			$(SRCPATH)games/spaceinvaders/objects/alienrocket_callback.c\
			...
			$(SRCPATH)games/spaceinvaders/objects/ufo.c		\
			$(SRCPATH)games/spaceinvaders/objects/ufo_callback.c
